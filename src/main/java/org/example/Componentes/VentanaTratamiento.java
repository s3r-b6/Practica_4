...
/**
 * Esta clase representa el JFrame de la "ventana de tratamientos" de la
 * aplicación
 */
public class VentanaTratamiento extends JFrame {
    ...
    /**
     * La acción que trata de añadir un nuevo tratamiento desde la ventana. Sólo
     * envía la señal de guardar
     * el nuevo tratamiento si los valores son validados correctamentes
     *
     * @param ventanaTratamiento Un puntero a la ventana, para cerrarla si tiene
     *                           éxito
     * @param c                  El controlador del animal
     * @param fecha              El contenedor en que se introduce la fecha de fin
     *                           del tratamiento
     * @param textArea           El contenedor en que se introduce la descripción
     *                           del tratamiento
     */
    public static void accionAddTratamiento(VentanaTratamiento ventanaTratamiento, Controlador c, JTextField fecha,
            JTextArea textArea) throws DateTimeParseException {
